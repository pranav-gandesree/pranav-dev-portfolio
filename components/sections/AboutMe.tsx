...
const AboutMe = () => (
  <section className="mb-16">
    ...
    <p className="text-gray-400 mb-10 text-lg">
      I&apos;m a 22-year-old tech enthusiast with a degree in Computer Science
      and Engineering, specializing in IoT. I love solving problems through
      technology and creating user-friendly, impactful web applications.
    </p>
    ...
    <p className="text-gray-400 mb-4 text-lg">
      ...
      Worked on designing and implementing a user-friendly web application for
      visual programming with Blockly for IoT devices. Integrated WebSocket
      technology for real-time communication and collaborated with
      cross-functional teams for IoT device interaction.
    </p>
