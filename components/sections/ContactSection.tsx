...
//       <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 w-4/5 md:w-3/5 lg:w-2/5 border border-slate-300 p-6 rounded-lg bg-customBlueGray shadow-md h-auto">
